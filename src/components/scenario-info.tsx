        ...
        <p className="text-muted-foreground">
          ...
          <Popover open={learnOpen} onOpenChange={setLearnOpen}>
            <PopoverTrigger asChild>
              <button
                className="ml-1.5 translate-y-0.5 inline-flex items-center justify-center rounded-full bg-yellow-500/20 p-1 text-yellow-600 hover:bg-yellow-500/30 dark:text-yellow-400 dark:hover:bg-yellow-500/40 transition-colors"
